...
namespace IC_Register_Analyzer.ViewModels
{
    ...
    /// <summary>
    /// 13ビットBカウンタ文字列入力値検証クラス
    /// </summary>
    class ADF4111_AB_BCounterValidationRules : ValidationRule
    {
        /// <summary>
        /// 入力値検証処理
        /// </summary>
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if ((Model_Register_ADF4111_ABCounter.B_Min_Threshold > ret) || (Model_Register_ADF4111_ABCounter.B_Max_Threshold < ret))
            {
                return new ValidationResult(false, "範囲内の値を入力してください。(" + Model_Register_ADF4111_ABCounter.B_Min_Threshold + "～" + Model_Register_ADF4111_ABCounter.B_Max_Threshold + ")");
            }
    ...
    /// <summary>
    /// 6ビットAカウンタ文字列入力値検証クラス
    /// </summary>
    class ADF4111_AB_ACounterValidationRules : ValidationRule
    {
        /// <summary>
        /// 入力値検証処理
        /// </summary>
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (Model_Register_ADF4111_ABCounter.A_Max_Threshold < ret)
            {
                return new ValidationResult(false, "範囲内の値を入力してください。(0～" + Model_Register_ADF4111_ABCounter.A_Max_Threshold + ")");
            }
