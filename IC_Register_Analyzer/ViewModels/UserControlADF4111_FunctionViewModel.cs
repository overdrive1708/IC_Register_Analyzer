...
{
    /// <summary>
    /// ADF4111の解析画面(ファンクション・ラッチ)
    /// </summary>
    public class UserControlADF4111_FunctionViewModel : BindableBase
    {
        /// <summary>
        /// バインディングデータ：解析データ
        /// </summary>
        private Model_Register_ADF4111_Function _registerData;
        public Model_Register_ADF4111_Function RegisterData
        {
        ...
        /// コンストラクタ
        /// </summary>
        public UserControlADF4111_FunctionViewModel()
        {
            //解析データ生成
            RegisterData = new Model_Register_ADF4111_Function();
        }
